    ...
    public function new(Request $request, EntityManagerInterface $entityManager, SluggerInterface $slugger, CategorieRepository $categorieRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                ...
                $this->addFlash('error', 'Une erreur est survenue lors du téléchargement de l\'imageTESTTESTTESTTESTLorem ipsum dolor sit amet consectetur adipiscing elit feugiat netus sem, torquent justo aliquam placerat fames luctus leo dapibus.');
