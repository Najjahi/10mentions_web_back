    ...
    <!-- <main class="container px-5 border border-dark">
        ...
        <div class="row">
            <h2 class="text-center my-5">5- Parcourir les tableaux grâce aux boucles</h2>
            <div class="col-sm-12 col-md-6">
            ...
            <div class="col-sm-12">
                ...
                <ul>
                    <li>La boucle "<span>foreach()</span>" est un moyen simple de passer un revue un tableau de façon automatique. Cette boucle ne fonctionne que sur les tableaux et les objets.</li>
