 ...
 <main class="container-fluid px-5">
    ...
    <h2> 3 - Extension".php" VS ".html" </h2>
        ...
        <ul>
          <li> L'instruction <span>echo</span> : permet d'effectuer un affichage; noun pouvons y mettre du HTML</li>
          ...
          <li>l'instruction <span> print</span>: c'est une instruction d'affichage. nous pouvons y mettre du HTML</li>
          <div class=" alert alert-primary w-50">
           <?php
            echo " je suis un texte en PHP dans une instruction <span> print </span> print ";         
           
          ?>
        
    </div>
          <li>les instructions dans une balise <span> var_dump()</span>et <span>print_r</span> : permettent d'afficher du contenu mais on s'en servira principalement pour débugger. ces deux fonctions permettent d'analyser dans le navigateur le contenu d'une variable par exemple (nous verrons l'utilisation plus tard)
    ...
    <div class ="col-sm-12">
        ...
        <h2> 6- les variables utilisateurs </h2>
              ...
              <div class="row justify-content-center">
                ...
                <p>les noms des variables suivants sont corrects :</p>
                <ul>
              ...
              <div class="col-sm-12 col-md-4 me-5 alert alert-danger">
                <p>les noms des variables suivants sont interdits :</p>
                <ul>
                  <li> <span>$*mavar</span></li>
              ...
              <div class="col-sm-12">
                <h2>7-affectations des variables utilisateurs</h2>
                <p>Affecter une variable consiste à lui donner une valeur : lorsque vous déclarer une variable vous ne lui donnez pas le type, c'est la valeur que vous lui Affecter qui va détérminer son type  </p>
                <ul>
            ...
            <div class="col-sm-12">
                ...
                <p>Une constante permet de conserver une valeur sauf que celle-ci ne peut pas changer. C'est à dire qu'on ne pourra pas la modifier durant l'éxécution duc script. Utile par exemple pour conserver les parametres de connexion à la BDD de façon certaine. </p>
