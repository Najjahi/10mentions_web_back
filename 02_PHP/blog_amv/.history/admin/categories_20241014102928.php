    ...
    <div class="container m-auto vh-100">
        <div class="row mt-5" style="padding-top: 8rem;">
            ...
            <div class="col-sm-12 col-md-6 mt-5">
                <h2 id="text3d" class="text-center fw-bolder mb-5 text-red">AJOUTER UNE CATEGORIE</h2>
            ...
            <div class="col-sm-12 col-md-6 d-flex flex-column mt-5 pe-3">
                ...
                <h2 id="text3d" class="text-center fw-bolder mb-5 text-red">LISTE DES CATEGORIES</h2>
                <?php
