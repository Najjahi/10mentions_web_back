...
function addCommentaire(int $article_id, string $commentaire, int $///////////////////// Une fonction pour creer la table commentaires/////////////
...
// createTableCommentaire();)
{
    ...
    $cnx = connexionBdd();
    $sql = "INSERT INTO commentaires (commentaire, article_id, commentaire_id) VALUES (:commentaire, :article_id, :commentaire_id)";
    $request = $cnx->prepare($sql);
    $request->execute(array(
