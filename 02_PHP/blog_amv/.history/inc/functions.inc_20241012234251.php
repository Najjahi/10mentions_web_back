...
define("RACINE_SITE", "http://localhost/blog_amv/");
...
function addCommentaire(int $article_id, string $commentaire, int $id_user)
{

    $cnx = connexionBdd();
    $sql = "INSERT INTO commentaires (commentaire, article_id, user_id) VALUES (:commentaire, :article_id, :user_id)";
    $request = $cnx->prepare($sql);
    $request->execute(array(
