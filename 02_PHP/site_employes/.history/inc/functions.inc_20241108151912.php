...
function foreignKey(string $employes, string $filiale_id, string $filiales, string $id_filiale)
{
    $cnx = connexionBdd();
    $sql = "ALTER TABLE $employes ADD FOREIGN KEY ($filiale_id) REFERENCES $filiales ($id_filiale)";
...
//foreignKey('employes', 'filiale_id', 'filiales', 'id_filiale');
...
function updateFiliale(string $name, string $description): void
{
    $cnx = connexionBdd();
