  ...
  <header>
    <nav class="navbar navbar-expand-lg fixed-top ">
      <div class="container-fluid">
        <h1><a class="navbar-brand" href="<?= RACINE_SITE ?>index.php"><img src="<?= RACINE_SITE ?>assets/img/logosaraweb-gold.png" alt=""> SARA Ressources </a></h1>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?= RACINE_SITE ?>admin/employes.php">Employes</a>
            </li>
              ...
              ?>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item text-dark fs-4" href="<?= RACINE_SITE ?>admin/filiales.php">Filiales</a></li>
                    <li><a class="dropdown-item text-dark fs-4" href="<?= RACINE_SITE ?>admin/employes.php">Employes</a></li>
                    <li><a class="dropdown-item text-dark fs-4" href="<?= RACINE_SITE ?>admin/users.php">utilisateurs</a></li>
                    <li><a class="dropdown-item text-dark fs-4" href="<?= RACINE_SITE ?>admin/gestion_employes.php">Gestion des employes</a></li>                   
