    ...
    <div class="d-flex flex-column m-auto ">
        ...
        <form action="" method="post" class="back">
            ...
            <div class="row justify-content-center">
                <button type="submit" class="btn btn-info p-3 my-3 text-light fw-bold">Envoyer</button>
                <button type="reset" class="btn btn-warning p-3 my-3 text-light fw-bold">Effacer</button>
            </div>
