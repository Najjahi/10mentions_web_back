    ...
    <div class="d-flex flex-column m-auto ">
        ...
        <form action="" method="post" class="back">
            ...
            <div class="row">
                ...
                <div class="col-md-8 mb-5">
                    ...
                    <select class="form-select" aria-label="Default select example">
                        <option selected> veillez selectionner votre demande</option>
            ...
            <div class="row justify-content-center">
                <button type="submit" class="btn btn-info p-3 my-3 text-secondary fw-bold">Envoyer</button>
                <button type="reset" class="btn btn-warning p-3 my-3 text-white fw-bold">Effacer</button>
            </div>
