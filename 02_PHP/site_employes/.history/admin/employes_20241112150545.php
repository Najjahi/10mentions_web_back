...
if (isset($_GET) && isset($_GET['action']) && isset($_GET['id_user']) && !empty($_GET['action']) && !empty($_GET['id_employe'])) {

    $idemploye = htmlentities($_GET['id_user']);

    if (is_numeric($iuser)) { //On vérifie si la valeur soumise pour le champ "id_employe" est bien un nombre.

        $user  = showEmployeViaId($idemploye);
...
<main>
    <div class="container">
        ...
        <div class="d-flex flex-column m-auto mt-5">
            ...
            <a href="gestion_employes.php" class="btn btn-success align-self-end "> <?= isset($employe) ? 'Modifier un employe' : 'Ajouter un employe' ?></a>
