...
<main>
  ...
  <div class="container m-auto">
        <div class="d-flex flex-column m-auto mt-5 table-responsive">
            ...
            <h2 id="text3d" class="text-center fw-bolder mb-5 ">LISTE DES UTILISATEURS</h2>
            <table class="table table-dark table-bordered mt-5">
                <thead>
                    <tr> <!-- tableau pour afficher toutles articles avec des boutons de suppression et de modification -->
                        ...
                        <th>D/* It looks like there is a typo in the code. The text `ate
                        d'embauche</th>` should actually be `Date d'embauche</th>`. This is a
                        table header cell indicating the date of hiring or employment for each
                        user in the table. */
                        ate d'embauche</th>
