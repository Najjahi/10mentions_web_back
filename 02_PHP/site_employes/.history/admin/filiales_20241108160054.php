        ...
        if (!isset($description) || strlen($description) < 20) {
            ...
            if ($filialeBdd) {
                ...
                if (isset($_GET) && $_GET['action'] == 'update' && !empty($_GET['id_filiale'])) {
                    ...
                    //J'appalle la fonction pour ajouter une filiale 
    ...
    <div class="container m-auto vh-100">
        <div class="row mt-5" style="padding-top: 8rem;">
            ...
            <div class="col-sm-12 col-md-6 mt-5">
                <h2 id="text3d" class="text-center fw-bolder mb-5 ">AJOUTER UNE FILIALE</h2>
                ...
                <form action="" method="post" class="back">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <button type="submit" class="btn btn-8secondary p-3"><?= isset($filiale) ? 'Modifier une filiale' : 'Ajouter une filiale' ?> </button>
                    </div>
                </form>
            </div>
