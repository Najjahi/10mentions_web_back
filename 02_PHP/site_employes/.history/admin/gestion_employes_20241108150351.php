        ...
        <div class="row">
            ...
            ?>
                ...
                <!-- si l'employe a déjà une filiale, le bouton est pré-coché, Sinon le bouton reste décoché. -->
                    <input class="form-check-input" type="radio" name="filiales" id="<?= html_entity_decode($filiale["name"]) ?>" value="<?= $filiale["id_filiale"] ?>" <?= isset($employe['filiale_id']) && $employe['filiale'] == $filiale['id_filiale'] ? 'checked' : '' ?>>
