...
<main>
    ...
    <h2 id="text3d" class="text-center fw-bolder mb-5 text-primary"><?= isset($employe) ? 'MODIFIER UN EMPLOYE' : 'AJOUTER UN EMPLOYE' ?> </h2> 
    ...
    <form action="" method="post" class="back" enctype="multipart/form-data">
        ...
        <div class="row justify-content-center">
            <button type="submit" class="btn btn-primary p-3 w-25"> <?= isset($employe) ? 'MODIFIER UN EMPLOYE' : 'AJOUTER UN EMPLOYE' ?></button>
        </div>
    </form>
</main>
<?php
