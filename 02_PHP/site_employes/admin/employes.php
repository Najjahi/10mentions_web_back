...
if (isset($_GET) && isset($_GET['action']) && isset($_GET['id_employe']) && !empty($_GET['action']) && !empty($_GET['id_employe'])) {
    ...
    if (is_numeric($iemploye)) { //On vérifie si la valeur soumise pour le champ "id_employe" est bien un nombre.
...
<main>
   ...
   <!-- Section pour afficher tous les employes qui existent dans la BDD  -->
        ...
        <div class="d-flex flex-column m-auto mt-5">
            ...
            <a href="gestion_employe.php" class="btn btn-danger align-self-end "> <?= isset($employe) ? 'Modifier un employe' : 'Ajouter un employe' ?></a>
            ...
            <table class="table table-dark table-bordered mt-5 ">
                ...
                <thead>
                    <tr>
                        ...
                        <th>Situation de l'employe</th>
                        <th>Nombre d'enfants de l'employe</th>
                        <th>Date d'embauche</th>
                        <th>Rôle de l'employe</th>
                        <th>Supprimer</th>
                        <th>Modifier</th>
                    </tr>
                </thead>
