    ...
    if ($verif == false) {
       ...
       */
        ...
        if (!isset($country) || strlen($country) < 5 ||  strlen($country) > 50 || preg_match($regex, $country)) {
          ...
          // vérifier si l'adresse email existe dans la BDD 
    ...
    <div class="w-75 m-auto p-5" style="background: rgba(20, 20, 20, 0.5);">
        ...
        <form action="" method="post" class="p-5">
            <div class="row mb-3">
                ...
                <div class=" mb-5">
                    <label for="firstName" class="form-label mb-3">Personne à contacter en cas d'urgence</label>
                    <input type="text" class="form-control fs-5" id="firstName" name="firstName">
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class=" mb-5">
                    <label for="phone" class="form-label mb-3">Téléphone ou Téléphone du responsable légale</label>
